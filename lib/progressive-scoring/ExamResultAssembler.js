...
export class ExamResultAssembler {
    ...
    async assembleCompleteResult(answers, progressiveResults, statisticalAnalysis, submissionMetadata = {}) {
        ...
        try {
            ...
            // Add comprehensive answer details
    ...
    async createBaseExamResult(answers, progressiveResults, submissionMetadata) {
        ...
        return {
            ...
            questionsUnattempted: this.questions.length - Object.keys(answers).length,
    ...
    /**
     * Assemble detailed answer information
     */
    async assembleAnswerDetails(answers, progressiveResults) {
        ...
        for (const [questionId, answer] of Object.entries(answers)) {
            ...
            const answerDetail = {
                ...
                questionNumber: question.questionNumber || answerDetails.length + 1,
                ...
                maxMarks: evaluationResult.maxMarks || 4,
                ...
                // Validation
                isValid: this.validateAnswerDetail(answer, question),
    ...
    generateComputationHash(data) {
        const hashData = {
            score: data.finalScore || data.totalScore,
