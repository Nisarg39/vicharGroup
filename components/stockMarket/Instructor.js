export default function Instructor() {
  return (
    <div className="bg-gradient-to-b from-gray-100 to-gray-200 pb-20 px-4 sm:px-6 lg:px-8">
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center text-gray-800 mb-8 sm:mb-12 hover:text-gray-700 transition-colors">Meet Your Instructor</h1>
        ...
        <div className="mt-8 sm:mt-12">
          ...
          <ul className="space-y-4 sm:space-y-6">
            ...
            <li className="flex items-start space-x-3 sm:space-x-4">
              ...
              <p className="text-gray-700 leading-relaxed text-sm sm:text-base">The common problem people experience is when they buy stocks, the price comes down, and when they sell, the price goes up, leading to capital loss.</p>
            </li>
            <li className="flex items-start space-x-3 sm:space-x-4">
              <span className="text-[#ff9f43] flex-shrink-0 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 sm:h-7 sm:w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li className="flex items-start space-x-3 sm:space-x-4">
              ...
              <p className="text-gray-700 leading-relaxed text-sm sm:text-base">Education in right direction helps us focus on the right things.</p>
            </li>
            <li className="flex items-start space-x-3 sm:space-x-4">
              <span className="text-[#ff9f43] flex-shrink-0 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 sm:h-7 sm:w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
