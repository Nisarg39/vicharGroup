...
function DirectorMessage() {
    ...
    return (
        <section className="bg-black text-white py-8 sm:py-12 md:py-12 lg:py-24 relative overflow-hidden">
            <div className="absolute inset-0 bg-opacity-10 bg-black backdrop-blur-sm"></div>
            <div className="container mx-auto px-4 relative z-10">
                <h2 className="text-4xl sm:text-4xl md:text-4xl lg:text-5xl font-extrabold text-center mb-6 sm:mb-10 text-white leading-tight">Director's Message</h2>
                <div className="max-w-6xl mx-auto">
                    <div className="bg-gradient-to-r from-[#ffffff] via-[#f0f0f0] to-[#ffffff] backdrop-blur-md p-4 sm:p-6 md:p-8 rounded-3xl shadow-2xl border-2 border-gray-800">
                        <div className="bg-[#0a0a0a] p-4 sm:p-6 md:p-8 rounded-3xl shadow-[0_20px_50px_rgba(0,_0,_0,_0.7)] hover:shadow-[0_20px_60px_rgba(0,_0,_0,_0.9)] transition-all duration-300 border-2 border-gray-800">
                            <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 md:gap-8">
                                <div className="w-full md:w-1/3 text-center border-b-2 md:border-b-0 border-[#106fb8] pb-2 md:pb-0">
                                    <div className="relative w-32 h-40 sm:w-40 sm:h-48 md:w-48 md:h-56 lg:w-64 lg:h-72 mx-auto group">
                                        <div className="absolute inset-0 bg-[#0f0f0f] rounded-2xl transform rotate-6 group-hover:rotate-12 transition-transform duration-300"></div>
                                    ...
                                    <div className="flex items-center justify-center space-x-2 mt-2">
                                        <p className="font-extrabold text-4xl sm:text-4xl md:text-4xl lg:text-4xl bg-gradient-to-r from-[#106fb8] via-[#4a9eda] to-[#106fb8] text-transparent bg-clip-text">
                                            VIVEK GUPTA
                                        </p>
                                    </div>
                                    <div className="flex items-center justify-end space-x-2">
                                        <p className="text-gray-300 text-base md:text-md font-medium">Director & Founder - </p>
                                        <div className="relative w-6 h-6">
                                            <Image src="/takalkarLogo.ico" alt="Director Icon" fill className="rounded-full border-2 border-[#106fb8]" />
                                        </div>
                                        <div className="relative w-6 h-6">
                                            <Image src="/Vichar_Navbar_Logo.png" alt="Founder Icon" fill className="rounded-full border-2 border-[#106fb8]" />
                                        </div>
                                    </div>
                                    <p className="text-gray-400 text-xs sm:text-sm font-medium bg-[#0f0f0f] inline-block rounded-full">( BTech IIT Madras )</p>
                                </div>
                                <div className="w-full md:w-2/2">
                                    <div 
                                        ref={scrollRef} 
                                        className="h-54 sm:h-40 md:h-48 overflow-y-auto mb-4 pr-4 flex items-center justify-center pt-2 md:pt-4 scrollbar-thin scrollbar-thumb-[#106fb8] scrollbar-track-[#0f0f0f]" 
                                    ...
                                    <div className="flex justify-between items-center mt-4 sm:mt-6">
                                        <button onClick={handlePrev} className="bg-black border border-[#1d77bc] text-white px-3 sm:px-4 md:px-6 py-2 sm:py-3 rounded-lg hover:bg-[#0f0f0f] hover:text-[#106fb8] transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl text-sm sm:text-base">←</button>
                                        <div className="flex space-x-1 sm:space-x-2">
                                            {[...Array(totalPoints)].map((_, index) => (
                                                <div
                                                    key={index}
                                                    className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full transition-all duration-300 transform hover:scale-125 cursor-pointer ${index === activeIndex ? 'bg-[#106fb8] scale-110' : 'bg-gray-500'}`}
                                                    onClick={() => setActiveIndex(index)}
                                                ></div>
                                            ))}
                                        </div>
                                        <button onClick={handleNext} className="bg-black border border-[#1d77bc] text-white px-3 sm:px-4 md:px-6 py-2 sm:py-3 rounded-lg hover:bg-[#0f0f0f] hover:text-[#106fb8] transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl text-sm sm:text-base">→</button>
                                    </div>
                                </div>
                            </div>
                        </div>
