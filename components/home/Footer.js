...
const Footer = () => {
    ...
    useEffect(() => {
        setIsClient(true);
        const savedExpandedState = localStorage.getItem('footerExpanded');
    ...
    const toggleFooter = () => {
        ...
        if (isClient) {
            localStorage.setItem('footerExpanded', JSON.stringify(newExpandedState));
        }
    };
        ...
        <footer className="bg-gradient-to-b from-white to-gray-50 border-t border-gray-200">
            ...
            <div className="container mx-auto px-4 md:px-8 py-2">
                <button 
                    ...
                    className="flex items-center justify-center w-full text-gray-600 hover:text-[#22a1d7] transition-colors duration-300"
            ...
            {/* Main footer content with transition */}
