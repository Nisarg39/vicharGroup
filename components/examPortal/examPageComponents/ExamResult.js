...
export default function ExamResult({ result, exam, onBack, onRetake, allAttempts = [] }) {
  ...
  // EMERGENCY QUEUE SYSTEM: Queue submission UI removed - background processing handled by Vercel cron jobs
  // Queued submissions no longer show polling UI - users are redirected to home with clear messaging
