...
const JeeHero = (props) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-200 flex flex-col items-center" id='courses-section'>
      <h1 className="text-5xl font-bold text-gray-800 mb-8 text-center pt-32">JEE Preparation Course</h1>
      <div className="container mx-auto w-full">
        <div className="flex flex-wrap justify-center gap-8 mb-0">
          {courses.map((course) => (
            <div key={course.id} className="bg-white rounded-lg shadow-md overflow-hidden transition duration-300 hover:shadow-lg border border-gray-200 hover:border-[#106fb8] max-w-xs border-b-4 border-b-[#106fb8]">
