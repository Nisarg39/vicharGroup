...
const JeeHero = (props) => {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center" id='courses-section'>
      <h1 className="text-5xl font-bold text-white mb-8 text-center pt-32">JEE Preparation Course</h1>
      <div className="container mx-auto w-full">
        <div className="flex flex-wrap justify-center gap-8 mb-0">
          {courses.map((course) => (
            <div key={course.id} className="bg-gray-900 rounded-lg shadow-md overflow-hidden transition duration-300 hover:shadow-lg border border-gray-800 hover:border-[#106fb8] max-w-xs border-b-4 border-b-[#106fb8]">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-400 mb-4 text-sm">Comprehensive JEE preparation course for {course.level} students.</p>
