        ...
        <div className="bg-gray-200">
            <section className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
                <p className="mb-4 text-base sm:text-lg">
                    <strong>The National Testing Agency (NTA)</strong> will administer the JEE Main exam in two sessions: January and April. Understanding the JEE Main exam pattern is crucial for successful preparation. The exam will be held in two shifts, morning and evening. The overall JEE Main paper pattern remains consistent for both sessions, though there are slight differences in the exam pattern for Paper.
                </p>
                <p className="text-base sm:text-lg">
                    <strong>The JEE Main exam pattern</strong> provides essential details such as test duration, marking scheme, subjects, total marks, and other relevant aspects. The exam will consist of total 75 questions carrying a total of 300 marks, each topic comprises 20 multiple-choice questions (MCQs) and 5 numerical value questions (NVQs).
                </p>
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mt-8 mb-4">Detailed JEE Main Exam Pattern</h2>
                <table className="w-full mt-8 border-collapse border border-gray-300 shadow-lg rounded-lg overflow-hidden">
                    ...
                    <tbody>
                        <tr className="bg-white hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td className="border border-gray-300 px-4 py-3">Computer-based (Online)</td>
                        </tr>
                        <tr className="bg-gray-100 hover:bg-gray-200 transition-colors duration-200">
                            ...
                            <td className="border border-gray-300 px-4 py-3">Physics, Chemistry, Mathematics</td>
                        </tr>
                        <tr className="bg-white hover:bg-gray-50 transition-colors duration-200">
                            <td className="border border-gray-300 px-4 py-3 font-semibold">Duration of Exam</td>
                            <td className="border border-gray-300 px-4 py-3">180 Minutes</td>
                        </tr>
                        <tr className="bg-gray-100 hover:bg-gray-200 transition-colors duration-200">
                            <td className="border border-gray-300 px-4 py-3 font-semibold">Type of Questions</td>
                            <td className="border border-gray-300 px-4 py-3">MCQ: 4 options with only 1 correct option.<br/>Numerical Value Questions whose answers need to be filled in as a numerical value.</td>
                        </tr>
                        <tr className="bg-white hover:bg-gray-50 transition-colors duration-200">
                ...
                <div className="mt-8">
                    ...
                    <p className="mb-2">
                        <strong>Jee Main:</strong> <a href="https://jeemain.nta.nic.in" className="text-blue-600 hover:underline">https://jeemain.nta.nic.in</a>
                    </p>
                    <p>
                        <strong>Jee Advanced:</strong> <a href="https://jeeadv.ac.in/" className="text-blue-600 hover:underline">https://jeeadv.ac.in/</a>
                    </p>
                </div>
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mt-8">JEE Main Exam Pattern: </h2>
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-xl mb-4">(Subject-wise distribution of mark)</h2>
                <h3 className="text-lg sm:text-lg md:text-md lg:text-lg mt-4 mb-2">Here's a detailed breakdown of the subject-wise distribution of marks in the JEE Main exam pattern:</h3>
                <div className="overflow-x-auto">
                    <table className="w-full mt-8 border-collapse border border-gray-300 shadow-lg rounded-lg overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <tr className="bg-white hover:bg-gray-50 transition-colors duration-200">
                                <td className="border border-gray-300 px-4 py-3 font-semibold">Mathematics</td>
                                <td className="border border-gray-300 px-4 py-3">20</td>
                                <td className="border border-gray-300 px-4 py-3">5</td>
                                <td className="border border-gray-300 px-4 py-3">100</td>
                            </tr>
