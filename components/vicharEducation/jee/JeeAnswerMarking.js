export default function JeeAnswerMarking() {
    return (
        <section className="max-w-full mx-auto px-4 py-8 bg-black">
        <div className="max-w-4xl mx-auto px-4 py-8">
            <h1 className="text-3xl font-bold text-white mb-6">Understanding JEE Main Answer Marking - MCQs and NVQs</h1>
            <div>
                <h2 className="text-2xl font-semibold text-gray-300 mb-4">For Multiple Choice Questions:</h2>
            ...
            <div className="mt-8">
                <h2 className="text-2xl font-semibold text-gray-300 mb-4">For Numerical Value Questions:</h2>
                <ul className="space-y-3 text-gray-300">
                    <li className="flex items-start">
                        <span className="inline-block w-2 h-2 bg-white rounded-full mr-3 mt-2"></span>
            ...
            <div className="mt-8">
                <h2 className="text-2xl font-semibold text-gray-300 mb-4">Few Guidelines and Important Facts for the Exam Day</h2>
