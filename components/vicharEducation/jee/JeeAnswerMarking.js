export default function JeeAnswerMarking() {
    return (
        <section className="max-w-full mx-auto px-4 pb-8 bg-gray-200">
        <div className="max-w-4xl mx-auto px-4 ">
            <h1 className="text-3xl font-bold text-black mb-6">Understanding JEE Main Answer Marking - MCQs and NVQs</h1>
            <div>
                <h2 className="text-2xl font-semibold text-gray-700 mb-4">For Multiple Choice Questions:</h2>
                <ul className="space-y-3 text-gray-600">
                    <li className="flex items-start">
                        <span className="inline-block w-2 h-2 bg-gray-700 rounded-full mr-3 mt-2"></span>
