      ...
      return (
          <section className="bg-white py-10 sm:py-20">
              <div className="container mx-auto px-4">
                  <h2 className="text-4xl sm:text-5xl font-bold text-center mb-8 sm:mb-12 text-gray-800 relative">
                      ...
                      <div className="flex space-x-4 sm:space-x-8 pb-4 testimonial-container">
                          {testimonials.map((testimonial, index) => (
                              ...
                              >
                                  ...
                                  <p className="text-gray-600 mb-4 sm:mb-6 italic text-sm sm:text-base leading-relaxed">
