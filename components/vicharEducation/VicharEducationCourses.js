    ...
    return (
        <div className="max-w-full mx-auto px-8 pb-10 pt-10 bg-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {courses.map((course) => (
                    <div key={course.id} className="bg-white rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl border-b-4 border-[#106FB7] flex flex-col max-w-[300px] mx-auto">
