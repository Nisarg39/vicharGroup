    ...
    return(
        <div className="bg-gray-200">
            <section className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
                ...
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mt-8 mb-4 text-gray-900">Detailed NEET Main Exam Pattern</h2>
                <table className="w-full mt-8 border-collapse border border-gray-300 shadow-lg rounded-lg overflow-hidden">
                    ...
                    <tbody>
                        <tr className="bg-gray-100 hover:bg-gray-200 transition-colors duration-200">
                            ...
                            <td className="border border-gray-300 px-4 py-3 text-gray-700">Offline</td>
                        </tr>
                        <tr className="bg-white hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <td className="border border-gray-300 px-4 py-3 text-gray-700">Physics, Chemistry, Biology</td>
                        </tr>
                        <tr className="bg-gray-100 hover:bg-gray-200 transition-colors duration-200">
                        ...
                        <tr className="bg-gray-100 hover:bg-gray-200 transition-colors duration-200">
                            ...
                            <td className="border border-gray-300 px-4 py-3 text-gray-700">720 Marks</td>
                        </tr>
                        <tr className="bg-white hover:bg-gray-100 transition-colors duration-200">
                            <td className="border border-gray-300 px-4 py-3 font-semibold text-gray-700">Medium of Exam</td>
                            <td className="border border-gray-300 px-4 py-3 text-gray-700">English, Hindi, Bengali, Urdu, Kannada, Malayalam, Assamese,Marathi, Odia, Telugu, Punjabi, Tamil and Gujarati.</td>
                        </tr>
                    </tbody>
                </table>
                <div className="mt-8 text-gray-700">
                    <h3 className="text-lg font-semibold mb-2 text-gray-900">NEET Exam Date:</h3>
                ...
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mt-8 text-gray-900">NEET Main Exam Pattern: </h2>
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-xl mb-4 text-gray-700">(Subject-wise distribution of mark)</h2>
                <h3 className="text-lg sm:text-lg md:text-md lg:text-lg mt-4 mb-2 text-gray-700">Here's a detailed breakdown of the subject-wise distribution of marks in the NEET exam pattern:</h3>
