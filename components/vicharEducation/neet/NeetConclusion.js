export default function NeetConclusion() {
    return (
        <section className="bg-gray-100 py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                ...
                <p className="text-sm sm:text-md text-gray-700 leading-relaxed">
                    This is a brief overview of the NEET exam, please visit the official website to check the latest exam pattern and details.
                </p>
            </div>
        </section>
    )
