...
const NeetHero = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-white to-gray-200 min-h-screen flex items-center pt-20" id='courses-section'>
      <div className="container mx-auto px-4 py-4 sm:py-8 md:py-6">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {courses.map((course) => (
            <div key={course.id} className="bg-white rounded-xl shadow-lg overflow-hidden transition duration-300 hover:shadow-xl border border-gray-200 hover:border-[#106fb8] max-w-xs border-b-4 border-b-[#106fb8]">
