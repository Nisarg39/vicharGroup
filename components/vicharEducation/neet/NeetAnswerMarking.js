export default function NeetAnswerMarking() {
    return (
        ...
        <div className="max-w-4xl mx-auto px-4 py-8 bg-black">
            <h1 className="text-3xl font-bold text-gray-200 mb-6">Understanding NEET Answer Marking - Section A and Section B</h1>
            <div>
                <h2 className="text-2xl font-semibold text-gray-300 mb-4">For Multiple Choice Questions (Section A):</h2>
            ...
            <div className="mt-8">
                <h2 className="text-2xl font-semibold text-gray-300 mb-4">For Section B:</h2>
                <ul className="space-y-3 text-gray-400">
                    <li className="flex items-start">
                        <span className="inline-block w-2 h-2 bg-white rounded-full mr-3 mt-2"></span>
