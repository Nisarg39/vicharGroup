                ...
                <div className="overflow-x-auto">
                    <div className="flex space-x-4 sm:space-x-8 pb-4 testimonial-container">
                        {testimonials.map((testimonial, index) => (
                            <motion.div 
                                key={index} 
                                className="bg-white p-4 sm:p-6 rounded-lg shadow-lg flex-shrink-0 w-80 sm:w-96"
                            ...
                            >
                                ...
                                <div className="mt-4 pt-3 border-t border-gray-200">
                                    <div className="flex items-center justify-center">
                                        <div>
                                            <h4 className="font-semibold text-gray-800 text-xs sm:text-sm mr-3 sm:mr-4">{testimonial.name}</h4>
                                        </div>
