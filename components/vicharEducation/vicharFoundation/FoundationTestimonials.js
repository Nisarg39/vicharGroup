      ...
      return (
        <section className="bg-black py-6 sm:py-10">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-12 text-white relative">
                ...
                <div className="overflow-x-auto">
                    <div className="flex space-x-4 sm:space-x-8 pb-4 testimonial-container">
                        {testimonials.map((testimonial, index) => (
                            <motion.div 
                                key={index} 
                                className="bg-gray-900 p-4 sm:p-6 rounded-lg shadow-lg flex-shrink-0 w-80 sm:w-96"
                            ...
                            >
                                ...
                                <div className="min-h-[150px]">
                                    <p className="text-gray-300 mb-3 sm:mb-4 italic text-sm sm:text-base leading-relaxed">
