...
const VicharFoundationHero = () => {
  return (
    <section className="min-h-screen bg-white flex flex-col items-center justify-center text-center px-4 py-16 pt-28 relative overflow-hidden">
      ...
      <div className="max-w-2xl relative z-10">
        ...
        <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-8 hover:text-gray-900 transition-colors duration-300">
