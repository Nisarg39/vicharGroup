export default function MhtCetAnswerMarking() {
    return (
        <section className="min-w-full bg-black">
        <div className="max-w-4xl mx-auto px-4 py-8 bg-black">
            <h1 className="text-3xl font-bold text-white mb-6">Understanding MHT-CET Answer Marking</h1>
            <div>
                <h2 className="text-2xl font-semibold text-gray-200 mb-4">For Multiple Choice Questions:</h2>
            ...
            <div className="mt-8">
                <h2 className="text-2xl font-semibold text-gray-200 mb-4">Important Notes:</h2>
                <ul className="space-y-3 text-gray-300">
                    <li className="flex items-start">
                        <span className="inline-block w-2 h-2 bg-white rounded-full mr-3 mt-2"></span>
