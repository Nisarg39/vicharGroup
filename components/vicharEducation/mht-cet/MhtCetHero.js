...
const MhtCetHero = (props) => {
  const courses = [
    ...
    { id: 3, title: 'Integrated Course', level: 'PCM & PCB', image: 'https://cdn-icons-png.flaticon.com/256/1005/1005141.png', link: '/vichar-coding' },
  ]

  return (
    <div className="bg-gradient-to-b pt-16 sm:pt-24 min-h-screen flex items-center" id='courses-section'>
      <div className="container mx-auto px-4 py-8 sm:py-16 md:py-20">
