...
const MhtCetHero = (props) => {
  const courses = [
    { id: 1, title: '11TH PCM Course', level: '11th', image: '/course-photo/cetIcon.jpeg', link: '/vichar-education/buy-course/cet-pcm/11' },
    { id: 2, title: '12TH PCM Course', level: '12th', image: '/course-photo/cetIcon.jpeg', link: '/vichar-education/buy-course/cet-pcm/12' },
    { id: 3, title: 'Integrated PCM Course', level: '11th + 12th', image: '/course-photo/cetIcon.jpeg', link: '/vichar-education/buy-course/cet-pcm/11+12' },
    { id: 4, title: '11TH PCB Course', level: '11th', image: '/course-photo/cetIcon.jpeg', link: '/vichar-education/buy-course/cet-pcb/11' },
    { id: 5, title: '12TH PCB Course', level: '12th', image: '/course-photo/cetIcon.jpeg', link: '/vichar-education/buy-course/cet-pcb/12' },
    { id: 6, title: 'Integrated PCB Course', level: '11th + 12th', image: '/course-photo/cetIcon.jpeg', link: '/vichar-education/buy-course/cet-pcb/11+12' },
  ]
  return (
