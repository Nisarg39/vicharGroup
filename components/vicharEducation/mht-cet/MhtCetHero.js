...
const MhtCetHero = (props) => {
  ...
  return (
    <div className="min-h-screen flex items-center" id='courses-section'>
      <div className="container mx-auto px-4 py-24 sm:py-28 md:py-24">
        <h1 className="text-5xl font-bold text-gray-900 text-center mb-12">MHT-CET Preparation Course</h1>
        <div className="flex flex-wrap justify-center gap-8">
          {courses.map((course) => (
            <div key={course.id} className="bg-white rounded-2xl shadow-lg overflow-hidden transition duration-300 hover:shadow-xl border border-gray-200 hover:border-[#106fb8] max-w-xs border-b-4 border-b-[#106fb8]">
              ...
              <div className="p-3.5">
                <h3 className="text-xl font-bold mb-2.5 text-gray-900 hover:text-[#106fb8] transition-colors duration-300">{course.title}</h3>
