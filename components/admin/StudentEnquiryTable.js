...
export const StudentEnquiryTable = () => {
  ...
  const renderEnquiryRow = (enquiry, index) => (
    <tr key={index} className={`${enquiry.seen ? 'bg-green-50' : 'bg-white'} border-b border-gray-50 last:border-0`}>
      ...
      <td className="px-2 sm:px-6 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-600">{enquiry.fullName}</td>
      <td className="px-2 sm:px-6 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-600">{enquiry.email}</td>
      <td className="px-2 sm:px-6 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-600">{enquiry.mobile}</td>
      <td className="px-2 sm:px-6 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-600">{enquiry.stream}</td>
      <td className="px-2 sm:px-6 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-600">{enquiry.class}</td>
      <td className="px-2 sm:px-6 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm">
        <button 
          ...
          className="text-blue-600 hover:text-blue-800 flex items-center gap-1 sm:gap-2 transition-colors duration-200"
        >
          {enquiry.seen ? (
            <>
              ...
              <span className="text-green-600 hover:text-green-700 text-xs sm:text-sm">Seen</span>
            </>
          ) : (
            <>
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="#1d77bc" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span className="text-[#1d77bc] hover:text-blue-800 text-xs sm:text-sm">View</span>
            </>
          )}
        </button>
      </td>
      <td className="px-2 sm:px-6 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm">
        <button 
          ...
          className="relative inline-flex h-5 sm:h-6 w-10 sm:w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        ...
        <DataTable 
          title={
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between w-full gap-4 sm:gap-0">
              <span className="text-lg sm:text-xl font-semibold">Student Enquiries</span>
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto">
                <div className="bg-blue-100 p-2 sm:p-3 rounded-lg shadow-md flex items-center gap-2 flex-1 sm:flex-initial">
                  ...
                  <div>
                    ...
                    <span className="text-blue-600 text-xs sm:text-sm ml-1 sm:ml-2">Total Messages</span>
                  </div>
                </div>
                <div className="bg-yellow-100 p-2 sm:p-3 rounded-lg shadow-md flex items-center gap-2 flex-1 sm:flex-initial">
                  ...
                  <div>
                    ...
                    <span className="text-yellow-600 text-xs sm:text-sm ml-1 sm:ml-2">Unseen Messages</span>
                  </div>
                </div>
              </div>
            </div>
  ...
  return (
    showModal && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white p-4 sm:p-6 rounded-lg w-full max-w-[320px] sm:max-w-[384px]">
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              onClick={onSubmit}
              className="px-3 sm:px-4 py-1.5 sm:py-2 text-sm sm:text-base bg-blue-600 text-white rounded hover:bg-blue-700"
            >
              Submit
            </button>
          </div>
