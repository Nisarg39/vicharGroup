const PrivacyPolicy = () => {
    return (
        <div className="container mx-auto px-4 py-12 sm:py-20 mt-6 sm:mt-24 max-w-5xl bg-white">
            <h1 className="text-3xl sm:text-4xl font-extrabold mb-10 sm:mb-14 text-center text-gray-900">Privacy Policy</h1>
            <div className="space-y-8 sm:space-y-10">
                {[
                    ...
                    <div key={index} className="border-b border-gray-200 pb-6 sm:pb-8 last:border-b-0 last:pb-0 hover:bg-gray-50 transition-colors duration-300 rounded-lg p-4 sm:p-6 bg-white">
